...
export async function producerConsoleHtml(): Promise<string> {
  ...
  return [
    ...
    "<article class=\"panel\"><div class=\"muted\">Suno</div><div class=\"metric\" id=\"suno-state\">-</div><div id=\"suno-meta\" class=\"muted\"></div><div class=\"list\"><div class=\"item\"><div class=\"muted\">Suno Current Run</div><strong id=\"suno-current-run\">-</strong></div><div class=\"item\"><div class=\"muted\">Last Imported</div><strong id=\"suno-last-imported\">-</strong></div><div class=\"item\"><div class=\"muted\">Last Create</div><strong id=\"suno-last-create\">-</strong><div id=\"suno-last-create-meta\" class=\"muted\"></div></div><div class=\"item\"><div class=\"muted\">Last Import</div><strong id=\"suno-last-import\">-</strong><div id=\"suno-last-import-meta\" class=\"muted\"></div></div></div></article>",
    ...
    "function formatOutcome(label,outcome){if(!outcome) return {title:`${label}: none`,detail:'No recorded outcome yet.'}; const status=outcome.accepted===false?'blocked':'accepted'; const runId=outcome.runId??'unknown'; const reason=outcome.reason??(typeof outcome.urlCount==='number'?`${outcome.urlCount} urls imported`:'no reason'); const at=outcome.at??'time unknown'; return {title:`${label}: ${status} (${runId})`,detail:`${reason} · ${at}`};}",
